    ...
    <>
      <div className="p-4 p-md-5 border rounded-3 mb-5">
        ...
        <p>
          ...
          <p>
            The "Trash" feature allows you to restore deleted notes or
            permanently delete them from your account.
          </p>
        </p>
        <p>
          <h4>
          ...
          <br />
          <p>
            The data we collect through Inkdown is directly relevant to
            providing you with a seamless text-editing experience and account
            management. We do not share your data with third parties without
            your consent, except as outlined in our Privacy Policy.
          </p>
          <p>
            ...
            from unauthorized access, alteration, or disclosure. Your passwords
            are encrypted to further enhance data protection.
          </p>
          <p>
            If you have any questions or concerns about how we collect and
            handle your data, please refer to our Privacy Policy or contact us
            at{" "}
